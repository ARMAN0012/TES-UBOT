...
async def nothanos(unbon):
    ...
    await unbon.edit("`Kita Unban ges, Kasian anak yatim...`")
    ...
    try:
        ...
        await unbon.edit("```Udah di Unban Jangan Jadi Jamet Lagi Ya Memek```")
        await sleep(3)
        await unbon.delete()
...
async def gspider(gspdr):
    ...
    await gspdr.edit("`Berhasil Membisukan Si Kontol`")
