...
async def _(event):
    ...
    if input_str == "owner":
        ...
        animation_chars = [
            "**OWNER KARMAN-USERBOT ADALAH MANUSIA TERGANTENG DI HATI PEMAKAI NYA, KENALAN DULU SAMA OWNER NYA YUK**"
            "** ARMAN NAMANYA,ORANG NYA BAIK**"
            "**TINGGAL NYA DI MEDAN, BTW ORANG MEDAN GANTENG GANTENG DAN THEBEST POKOK NYA AWWHHHH**"
